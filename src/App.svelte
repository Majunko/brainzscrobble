...
<div class="flex min-h-svh w-full flex-col">
  ...
  <footer class="mx-auto w-full max-w-[1600px] px-3 pt-2 pb-6 text-center text-xs sm:px-5 lg:px-8">
    <div class="flex flex-col items-center gap-2">
      <p class="t-faint">
        {t('app.footer')}
      </p>
      <a
        class="inline-flex items-center gap-1.5 t-faint transition hover:t-soft"
        href="https://github.com/Majunko/brainzscrobble"
        target="_blank"
        rel="noreferrer"
      >
